  ...
  return (
    <html lang="en" className="dark">
      <body className={`font-sans antialiased`}>
        ...
        <Analytics />
      {/* v0 - built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-de5ab977-2c77-42d6-b259-a9360c4d9d16" style="
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_b5oqtJJhdYu"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-de5ab977-2c77-42d6-b259-a9360c4d9d16').style.display='none'"
